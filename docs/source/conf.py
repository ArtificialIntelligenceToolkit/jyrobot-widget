...
# -*- coding: utf-8 -*-
#
# jyrobot documentation build configuration file
#
...
_version_py = os.path.join(repo, 'jyrobot', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'jyrobot.tex', 'jyrobot Documentation',
